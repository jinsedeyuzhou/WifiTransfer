package com.ebrightmoon.wifitransfer;
...
public class MainActivity extends AppCompatActivity implements Animator.AnimatorListener ,View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rxPermissions
                .request(Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.REQUEST_INSTALL_PACKAGES)
                .subscribe(granted -> {
